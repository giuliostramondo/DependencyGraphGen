...
%%% Draw system flow diagram
   \begin{scope}[xshift=-7.5cm,yshift=-5cm,very thick,
       ...
       \draw [-,opacity=0] (cbbl.center) -- (cbbr.center)
       node [pos=1/2] (cbmidhook){};
       \draw [-,opacity=0] (cbtl.center) -- (cbtr.center)
       node [pos=1/2] (ctmidhook){};
       \draw [-, opacity=0] (ctmidhook.center) -- (cbmidhook.center)
       node[pos=1/2,opacity=1] (ctexthook){X-bar};
       %END CROSSBAR
       ...
       node [pos=2/4] (cbRFTmid){}
       node [pos=6/8] (muxrfAddDemux){};

       \draw [-,opacity=0] (cbRFTmid.center) -- (cbRFBmid.center)
       node [pos=1/2,opacity=1] (cbRFtexthook){X-bar};
       ...
       \draw [-,opacity=0] (cbRF2.north west) -- (cbRF2.north east)
        ...
        \draw[-,opacity=0] (cbRF2.south west) -- (cbRF2.south east)
            node [pos=2/8] (rfMuxA){}
        node [pos=2/4] (cbRF2Bmid){}
        node [pos=6/8] (rfMuxB){};

                 \draw [-,opacity=0] (cbRF2Tmid.center) -- (cbRF2Bmid.center)
       node [pos=1/2,opacity=1] (cbRF2texthook){X-bar};
