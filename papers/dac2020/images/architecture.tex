...
\node [event] (memoryl2) {Level 2\\ \small (SRAM, MRAM, eDRAM)};
\node [event,fill=white,below=of memoryl2.south,below=0pt] (separation) {};
\node [event,below=of separation.south,below=0pt] (memoryl1) {Level 1\\ \small (SRAM)};
\node [block, below=of memoryl1.south,below=0pt] (processor) {Custom\\Processor};
